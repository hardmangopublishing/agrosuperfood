---
title: "Jars, Trays, and Automatic Sprouters"
slug: "guide-jars-vs-trays"
kind: "spoke"
hub: "hub-sprouting"
hero: "img-jar-vs-tray"
description: "Which sprouting system to buy, decided by which failure you are personally likely to produce rather than by which one is best."
siblings: ["guide-mung-beans", "guide-microgreens-no-soil"]
updated: "2026-07-29"
---
...
**Where it fails.** Capacity is the obvious limit. A one litre jar comfortably produces four to six cups of finished sprouts, which is a household's weekly supply and not a day's if you are enthusiastic. The subtler limit is the drainage angle. A jar sitting too flat pools water at the base, and pooled water is the direct cause of the sour batch that makes people quit. The [hub page](hub-sprouting.html) has the cross section showing the angle that works.
...
1. Run four consecutive batches on a jar before buying anything else. Note which failure you actually hit.
2. If your lid is plastic and warping, replace it with stainless and change nothing else.
3. Measure your available counter space honestly before considering a tray stack or a machine.
4. If you have hard water and are considering an automatic unit, find its descaling schedule before you buy, not after.
:::

## Next

If you have not run a full cycle yet, start with [mung beans start to finish](guide-mung-beans.html), which is the batch this whole comparison assumes you have already attempted.

If your interest is really in flavour and presentation rather than volume, the equipment question changes completely. [Microgreens without soil](guide-microgreens-no-soil.html) covers mats, light, and the tray setup that job actually needs.
