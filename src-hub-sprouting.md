---
title: "Sprouting and Microgreens at Home"
slug: "hub-sprouting"
kind: "hub"
description: "What germination changes, the safety question most guides skip, and the three ways to run a batch at home."
updated: "2026-07-29"
hero: "img-sprouting-hero"
verify:
  - "Current food safety guidance on raw sprouts from your national authority"
  - "Glucoraphanin and sulforaphane figures before any quantitative claim is added"
  - "Seed supplier pathogen testing claims, per supplier, before naming any"
---
...
The complete four day cycle on the most forgiving seed there is: [mung beans start to finish](guide-mung-beans.html).

The fastest sprout in the cupboard, and the one supermarket variety that will never germinate: [lentils and the red lentil trap](guide-lentil-sprouts.html).

An honest account of the research that brought most people here, plus a growing method for a seed that clumps: [broccoli sprouts and what the research actually says](guide-broccoli-sprouts.html).

The finest seed most people attempt, and the mechanical fix for the failure it is famous for: [alfalfa without the slime](guide-alfalfa-sprouts.html).

Which vessel to buy, decided by which failure you personally produce: [jars, trays, and automatic sprouters](guide-jars-vs-trays.html).

What rinsing actually does, and which steps are protecting you rather than the batch: [rinsing and drainage as safety controls](guide-rinsing-drainage.html).

Viability decay, the twenty seed test, and what the labels do and do not tell you: [buying sprouting seed in bulk](guide-buying-seed.html).

Mats, coir, sowing density, and bottom watering: [microgreens without soil](guide-microgreens-no-soil.html).

The one variable no other technique can compensate for: [grow lights for a windowsill run](guide-grow-lights.html).

The ten minutes after cutting that decide whether a tray lasts a week or two days: [harvesting and storing microgreens](guide-harvest-storage.html).
