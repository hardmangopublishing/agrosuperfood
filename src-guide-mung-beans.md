---
title: "Mung Beans, Start to Finish"
slug: "guide-mung-beans"
kind: "spoke"
hub: "hub-sprouting"
hero: "img-jar-drain"
description: "The complete four day cycle for mung bean sprouts, including the two mistakes that ruin most first batches."
...
1. Measure exactly three tablespoons of sprouting grade mung beans. Not a handful, and not a quarter cup by eye.
2. Set two alarms, morning and evening, and leave them running for the whole first batch.
3. Rinse, drain hard, and set the jar mouth down at a steep angle tonight.
4. Write the date and the seed lot number on a piece of tape on the jar.
:::

## Next

Once you have run two clean batches, the next decision is whether your constraint is volume, cost, or consistency. [Jars, trays, and automatic sprouters](guide-jars-vs-trays.html) covers which upgrade solves which problem, and why buying the wrong one is the usual outcome.

If you came to sprouting for a specific reason rather than for the practice of it, [broccoli sprouts and what the research actually says](guide-broccoli-sprouts.html) is the honest version of the page that sold you on the idea.
