---
title: "Harvesting and Storing Microgreens"
slug: "guide-harvest-storage"
kind: "spoke"
hub: "hub-sprouting"
hero: "img-mat-stack"
description: "The ten minutes after cutting decide whether a tray lasts a week or two days, and washing them is the fastest way to waste the work."
siblings: ["guide-microgreens-no-soil", "guide-grow-lights"]
updated: "2026-07-29"
---
...
The practical consequence is that yield planning should assume one cut per tray. Anyone budgeting seed for a weekly rotation should count trays rather than harvests, and the [hub page](hub-sprouting.html) covers where that sits against the far cheaper economics of jar sprouting.
...
1. Stop watering the tray on the morning you plan to harvest.
2. Check your scissors cut paper cleanly. If they do not, use a different pair.
3. Cut a centimetre above the medium, in small handfuls, laying rather than dropping them into a rigid container lined with a dry paper towel.
4. Wash only the portion you are about to eat, immediately before eating it.

## Next

For the growing setup that produces a tray worth harvesting properly, see [microgreens without soil](guide-microgreens-no-soil.html).

If your crop is stretching and pale before it ever reaches the harvest window, the problem is upstream of anything on this page. [Grow lights for a windowsill run](guide-grow-lights.html) covers the one variable that no harvest technique can compensate for.
